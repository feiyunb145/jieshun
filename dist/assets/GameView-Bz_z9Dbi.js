import{B as e,C as t,R as n,S as r,T as i,_ as a,b as o,c as s,h as c,i as l,l as u,m as d,o as f,r as p,s as m,u as h,v as g,w as _,z as v}from"./vue-vendor-Bu9dmlp0.js";import{n as ee,r as y,t as b}from"./index-CAPkNEz-.js";var x={npc_profile:{name:`小捷`,layers:{layer0_hard_rules:[`绝不对客户表现出不耐烦`,`绝不用"您说得对但是"否定式承接`,`所有数据必须有出处（案例/报告/官网可查）`],layer1_identity:`捷顺科技To B销售，从业5年，服务200+车场，MBTI: ESFJ`,layer2_expression:{style:`口语化，像聊天不像背稿`,catchphrases:[`您放心`,`哈哈哈您真幽默`,`理解理解`],response_structure:`承接质疑 → 举证(数据+案例) → 收尾推进(三段式)`,banned:[`专业术语不解释`,`居高临下语气`]},layer3_power:{vs_objection:`不卑不亢，用数据回应`,vs_acceptance:`乘胜追击，用案例巩固`,vs_hesitation:`主动降低门槛`},layer4_emotion:{stability:7,expressions:{normal:`😐`,questioned:`🤔`,confident:`😏`,closed:`😄`}}}},nodes:{cover:{type:`cover`,title:`🚗 车场老板的谈判挑战`,subtitle:`今天，有个销售上门给你推方案...`,intro:`你是小区车场老板老王，
每月利润3万块，
全国车位缺口超8000万，
可你的泊位利用率才40%。
